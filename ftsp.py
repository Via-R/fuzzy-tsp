...
approximation_types = {
    "crisp": "crisp",
    "triangular_rank": "triangular_approximation",
    "parabolic_rank": "parabolic_approximation",
}


def get_approximation_type(method: str) -> str:
    return approximation_types.get(method) or approximation_types["parabolic_rank"]
